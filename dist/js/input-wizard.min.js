...
!function(f,i){"use strict";const n="inputWizard",o={enabled:!0,popupSettings:{lists:[],defaultListIndex:0,defaultIndex:0,inputControlClass:"input-control",inputManagerClass:"input-manager"},selectOnSpacebar:!0,formatter:null,triggers:null,events:{onDataLoad:function(t){return!0},onSelected:null},extensions:{getSelectorPositionOverride:null}};function r(){var n={};this.setSearchCache=function(t,e){n[t]=e},this.getSearchCache=function(t){return n[t]}}const I={UP:38,DOWN:40,LEFT:37,RIGHT:39,BACKSPACE:8,DELETE:46,ESCAPE:27,ENTER:13,SPACEBAR:32,TAB:9};function s(t,e){const a=t instanceof jQuery?t:f(t),l=this,u={enabled:!0,enableCache:!0,currentMatchStartLocation:-1,optionSelectorStateInfo:null,debounceTimer:null,highlight:f("<div class='highlight'></div>"),settings:null};u.settings=f.extend(!0,{},o,e),u.enabled=u.settings.enabled;var d=new OptionSelector({lists:u.settings.popupSettings.lists,defaultListIndex:u.settings.popupSettings.defaultListIndex,defaultIndex:u.settings.popupSettings.defaultIndex,rootListClass:u.settings.popupSettings.rootListClass,rootListItemClass:u.settings.popupSettings.rootListItemClass,visible:!1,events:{onClicked:function(t){a.focus(),d.getVisible()&&(g(d,a),d.setVisible(!1))},onVisibilityChanged:function(t){t||(S.unsetHighlight(u.highlight),u.currentMatchStartLocation=-1,u.optionSelectorStateInfo=null)}},extensions:{formatter:u.settings.formatter}}),p=new r,S=new InputManager(a,{containerClass:u.settings.popupSettings.inputManagerClass});function n(t,e){return t.bind?t.bind(e):function(){t.apply(e,arguments[2])}}var c=function(t,e,n){var i;!(47<(i=n)&&i<58||32===i||64<i&&i<91||95<i&&i<112||185<i&&i<193||218<i&&i<223)&&[I.BACKSPACE,I.DELETE].indexOf(n)<0||(i=t&&n==I.SPACEBAR&&!d.getVisible(),s(t,n,i))},s=function(t,e,n){var i=S.getInputState(),s=i.preText;if(s&&s.trim().length){for(var o=0;o<u.settings.triggers.length;o++){var r=u.settings.triggers[o],a=null;if(n?(a=s.match(r.match))&&(u.currentMatchStartLocation=s.length-a[a.length-1].length):s.length<=s.replace(/\s+$/,"").length&&(u.currentMatchStartLocation<0&&(u.currentMatchStartLocation=s.length-1),-1<u.currentMatchStartLocation&&(a=s.substring(u.currentMatchStartLocation).match(r.match))),a){var l,c=a[a.length-1],g=p.getSearchCache(c);S.setHighlight(u.highlight,i.preText,i.postText,c),null!=g?(l=g[0],g=g[1],h(i,l,c)(g)):r.search(c,h(i,r,c));break}}a?S.unsetHighlight(u.highlight):d.setVisible(!1)}else d.setVisible(!1)},h=function(n,i,s){return function(t){var e=!1;t&&u.settings.events.onDataLoad&&(e=u.settings.events.onDataLoad.call(l,t),!p.getSearchCache(s)&&u.enableCache&&p.setSearchCache(s,[i,t])),e&&S.getInputState().preText==n.preText&&(d.setData(t),u.optionSelectorStateInfo={preText:n.preText,postText:n.postText,trigger:i,term:s},d.getVisible()||(e=n.cursorOffset,u.settings.extensions.getSelectorPositionOverride&&(t=u.settings.extensions.getSelectorPositionOverride(e),d.getUIRoot().css(t)),d.setVisible(!0)))}},g=function(t,e){var n,i,s,o,r;S.unsetHighlight(u.highlight),t.getVisible()&&(n=u.optionSelectorStateInfo.trigger,i=u.optionSelectorStateInfo.term,s=t.getSelectedDataItem(),t=n.replace(s,i,t.getSelectedIndex().listIndex),r=o=null,r=u.currentMatchStartLocation<0?f.isArray(t)?(o=u.optionSelectorStateInfo.preText.replace(n.match,t[0]),t[1]+u.optionSelectorStateInfo.postText):(o=u.optionSelectorStateInfo.preText.replace(n.match,t),u.optionSelectorStateInfo.postText):f.isArray(t)?(o=u.optionSelectorStateInfo.preText.substring(0,u.currentMatchStartLocation)+u.optionSelectorStateInfo.preText.substring(u.currentMatchStartLocation).replace(n.match,t[0]),t[1]+u.optionSelectorStateInfo.postText):(o=u.optionSelectorStateInfo.preText.substring(0,u.currentMatchStartLocation)+u.optionSelectorStateInfo.preText.substring(u.currentMatchStartLocation).replace(n.match,t),u.optionSelectorStateInfo.postText),e.val(o+r),S.setCursorPosition(o.length),u.settings.events.onSelected&&u.settings.events.onSelected.call(l,i,s)),d.setVisible(!1)},t=f("<div></div>");t.addClass(u.settings.popupSettings.inputControlClass),a.before(t).detach(),t.append(u.highlight),t.append(d.getUIRoot()),t.append(a),f(i.body).bind("click",function(t){0==f(t.target).closest(d).length&&d.setVisible(!1)});return a.on("keydown",n(function(t){if(u.enabled){var e,n,i,s=t.which,o=t.ctrlKey,r=t.shiftKey;if(S.updateCursorPosition(),d.getVisible()){if(s===I.ESCAPE)return t.preventDefault(),void d.setVisible(!1);if(s===I.UP)return t.preventDefault(),void d.setSelectedIndex(d.getSelectedIndex().listItemIndex-1);if(s===I.DOWN)return t.preventDefault(),void d.setSelectedIndex(d.getSelectedIndex().listItemIndex+1);if(s==I.LEFT)return t.preventDefault(),void(-1<(e=d.getSelectedIndex().listIndex-1)&&(n=d.getSelectedIndex().listItemIndex,i=d.getListItemCount(e),d.setSelectedIndex(n=i<=n?i-1:n,e)));if(s==I.RIGHT)return t.preventDefault(),void((e=d.getSelectedIndex().listIndex+1)<d.getListCount()&&(n=d.getSelectedIndex().listItemIndex,i=d.getListItemCount(e),d.setSelectedIndex(n=i<=n?i-1:n,e)));if(s===I.ENTER||s===I.SPACEBAR&&u.settings.selectOnSpacebar){if(s===I.ENTER&&d.getVisible()&&(t.preventDefault(),t.stopPropagation(),t.stopImmediatePropagation()),!o)return void g(d,a)}else if(s===I.TAB)return t.preventDefault(),e=d.getSelectedIndex().listIndex,n=d.getSelectedIndex().listItemIndex,i=d.getListItemCount(e),void(r?0==n&&0<i?d.setSelectedIndex(i-1):d.setSelectedIndex(n-1):i-1<=n&&0<i?d.setSelectedIndex(0):d.setSelectedIndex(n+1))}else if(-1<[I.BACKSPACE,I.DELETE].indexOf(s))return;setTimeout(c,0,o,r,s)}},l)),a.on("scroll",n(function(t){},l)),{setEnabled:function(t){u.enabled=!!t,S.setEnabled(u.enabled),d.setEnabled(u.enabled),S.unsetHighlight(u.highlight),t||d.setVisible(!1)},getEnabled:function(){return u.enabled},getInputState:function(){return S.getInputState()}}}s.prototype={getEnabled:function(){return getEnabled()},setEnabled:function(t){setEnabled(t)},getInputState:function(){this.getInputState()}},f.fn[n]=function(e){return this.each(function(){var t;f.data(this,n)||(t=new s(this,e),f.data(this,n,t))})}}(jQuery,(window,document));